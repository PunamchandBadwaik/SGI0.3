							...
							<div class="box-content row">
								<div class="col-lg-12 col-md-12 animated fadeIn">
									...
									<table
										...
										<tbody>
											<tr>
												<td><s:property value="challanDetails.challanNumber" /></td>
												<td><s:property
														value="challanDetails.date" /></td>
												<td><s:property value="challanDetails.name" /></td>
												<td><s:property value="challanDetails.amount" /></td>
												<td><s:property
														value="challanDetails.rollNo" /></td>
											</tr>
										</tbody>
									</table>
