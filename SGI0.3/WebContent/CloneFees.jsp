	...
	<div class="ch-container">
		<div class="row">
			...
			<div id="content" class="col-lg-10 col-sm-10">
				...
				<div class="row">
					<form action="cloneFees" enctype="multipart/form-data"
						method="post">
						<div class="box col-md-12">
							<div class="box-inner">
								<div class="box-header well">
									<h2>
										<i class="glyphicon glyphicon-info-sign"></i> Select Institute From which fees should be cloned
									</h2>
												...
												<tr>
													...
													<td colspan="2">
														<div id="the-basics" class="has-success">
															<select data-rel="chosen" name="affInstBean.instId"
																style="width: 300px;">
