		...
		<div >	<!-- class="row" -->
			...
			<div > <!-- class="row" -->
				<div class="col-md-12 center login-header">
					<h2>Please Enter Your Registered Details</h2>
				</div>
				<!--/span-->
			</div>
			<!--/row-->
			...
			<div >		<!-- class="row" -->
				<div class="well col-md-5 center login-box" >
					...
					%>
					<div class="alert alert-info">Forgot Password Page
					.</div>
					<%
						}
					%>
					...
					<form class="form-horizontal" action="forgetPasswordPage" method="post">
						<fieldset>
						...
						<tr><td>Profile</td><td><select name="profile" class="form-control" required="required" >
						...
						<tr><td>Email Id</td><td><input type="email"
									...
									required="required" placeholder="Email Id"></td></tr>
