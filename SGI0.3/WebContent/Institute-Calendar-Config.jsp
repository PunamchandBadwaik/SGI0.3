								...
								<div class="col-lg-12 col-md-12 animated fadeIn">
									...
									<p class="btn-group">
										<button class="btn btn-default"
											onclick='window.open("CreateCalendar.jsp","Feature Lock","width=1000 height=500")'>
											Create Calendar </button>
										<button class="btn btn-default"
											onclick='window.open("createPayMentCycle","Feature Lock","width=1000 height=1200")'>Generate Payment Cycle</button>
										 <button class="btn btn-default"
											onclick='window.open(" LockFeature.jsp","Feature Lock","width=500 height=500")'>View Cycle
											Parameters</button> 
									</p>
