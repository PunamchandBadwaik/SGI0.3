					...
					<div class="box col-md-12">
						<div class="box-inner">
							<div class="box-header well">
								...
								<h2>
									<i class="glyphicon glyphicon-info-sign"></i> Transaction Detail
								</h2>
							...
							<div class="box-content row">
								<div class="col-lg-12 col-md-12 animated fadeIn">
									...
									%>
									<form action="getQuickPayStudentRecordByOperator" method="post">
										<table class="table table-condensed">
											<tr>
											<tr>
												<td style="font-weight: bold;">UIN :</td></tr>
											<tr>	<td style="font-weight: bold;">Student Name :</td></tr>
											<tr>	<td style="font-weight: bold;">Amount :</td></tr>
											<tr>	<td style="font-weight: bold;">Transaction Id :</td></tr>
											...
											onclick="gotoLogin()">Quit</button> </td></div>
