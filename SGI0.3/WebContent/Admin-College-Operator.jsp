					...
					<div class="box col-md-12">
						<div class="box-inner">
							<div class="box-header well">
								<h2>
									<i class="glyphicon glyphicon-list-alt"></i> Institute Operator
									Details
								</h2>
 ...
 %>
									...
									<table
										...
										<tbody>
											...
											%>
											<!-- listAffBean -->
											<!-- child list name= listOprtBean-->
											<c:forEach items="${listOprtBean}" var="optr">
												<tr>
													<td><%=i%></td>

													<td class="center"><c:out value="${optr.operatorName}" />
													</td>
