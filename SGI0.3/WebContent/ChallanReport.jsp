					...
					<div class="box col-md-12">
						<div class="box-inner">
							<div class="box-header well">
								<h2>
									<i class="glyphicon glyphicon-list-alt"></i> Challan Report
								</h2>
									...
									<div class="row">
										<div class="col-md-12">
											<button class="btn btn-sm btn-info pull-right"
												onclick='window.open("LockFeature.jsp", "CollegeForm", "width=1500,height=1080")'>
										...
										<tbody>
											...
											<s:iterator value="allChallanInfo">
												<tr>
                                                    ...
                                                    <tr> --%>
													<td><s:property value="challanNumber" /></td>
													...
													<td><span style="margin-left: 10px;"><input
															...
															onclick='window.open("serachByChallanNumber?challanNum=<s:property value="challanNumber"/>", "CollegeForm", "width=500,height=700")'>
													</span></td>
